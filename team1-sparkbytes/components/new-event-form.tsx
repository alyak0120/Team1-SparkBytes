'use client';
import {Form, Input, Button, Select, Card, Typography, DatePicker, TimePicker, Space, ConfigProvider, theme} from 'antd';
    ...
    return (
        ...
        <Space
            ...
            <Card
                ...
                <Typography.Title level={2} style={{textAlign: "center", marginBottom: 24, color: "#CC0000"}}>
                    Post a New Event
                </Typography.Title>
                <Form layout="vertical" onFinish={handleFinish}>
                    ...
                    <Form.Item
                        ...
                        style={{flex:1}}
                    >
                        <TimePicker style={{width:"100%"}} format="h:mm A" use12Hours minuteStep={5} />
                    </Form.Item>
                    </Space>
